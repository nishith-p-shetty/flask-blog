...
app.config.update(
    ...
    MAIL_DEFAULT_SENDER = params['mail_default']
)
mail = Mail(app)
...
def contact():
    if (request.method == 'POST'):
        ...
        msg1 = Message("New Message from Blog, " + name, recipients=[params['mail_recipient']])
        msg1.body = message + "\n" + phone
        mail.send(msg1)
        msg2 = Message(name + ", Contact Information Received", recipients=[email])
        msg2.body = "We have received your Information, We will contact you.\n" + message + "\n" + phone
        mail.send(msg2)
